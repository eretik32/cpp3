 ...
 */
class Version20190811130737 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C53D045F7909E1ED ON image (research_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C53D045F7909E1ED ON image');
