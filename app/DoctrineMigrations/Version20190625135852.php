 ...
 */
class Version20190625135852 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE image_moderation CHANGE product_id product_id INT DEFAULT NULL, CHANGE typeimage_id typeimage_id INT DEFAULT NULL');
